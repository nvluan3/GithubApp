...
function Show-Menu {
    ...
    Write-Host "========================================================="
    Write-Host "1. Cai dat may in RICOH Aficio MP 6001 (MAY 1)"
    Write-Host "2. Cai dat may in RICOH Aficio MP MP 3054 (MAY 2)"
    Write-Host "3. Cai dat may in RICOH Aficio MP 9002 (MAY 3)"
    Write-Host "4. Cai dat may in RICOH Aficio MP 9002 (MAY 4)"
    Write-Host "5. Cai dat may in RICOH MP C4504 (MAY 5)"
    Write-Host "6. Cai dat may in RICOH Aficio MP 6001 (MAY 6)"
    ...
    Write-Host "12. Mo Device and Printers"
...
do {
    Show-Menu
    $choice = Read-Host "Nhap lua chon (1-12 hoac 0 de thoat)"
    switch ($choice) {
        "1" {
            ...
            $printer1Name = "RICOH Aficio MP 6001 (sadora may 1)"
